...
void fill_cfg_widgets(void)
{
    ...
    fl_g->check_cfg_update_from_url->value(cfg.main.song_update_url_active);
    ...
    if (cfg.rec.overwrite_files) {
        fl_g->check_cfg_overwrite_existing_files->value(1);
    }
    else {
        fl_g->check_cfg_overwrite_existing_files->value(0);
    }
    ...
    fl_g->input_gui_listeners_update_rate->value(cfg.gui.listeners_update_rate);
    ...
    fl_g->check_stream_mp3_force_min_bitrate->value(cfg.mp3_codec_stream.vbr_force_min_bitrate);
    ...
    fl_g->check_stream_mp3_activate_lowpass_width->value(cfg.mp3_codec_stream.lowpass_width_active);
    fl_g->input_stream_mp3_lowpass_width->value(cfg.mp3_codec_stream.lowpass_width);
    fl_g->check_stream_mp3_activate_highpass_freq->value(cfg.mp3_codec_stream.highpass_freq_active);
    fl_g->input_stream_mp3_highpass_freq->value(cfg.mp3_codec_stream.highpass_freq);
    fl_g->check_stream_mp3_activate_highpass_width->value(cfg.mp3_codec_stream.highpass_width_active);
    fl_g->input_stream_mp3_highpass_width->value(cfg.mp3_codec_stream.highpass_width);

    cfg.mp3_codec_stream.lowpass_freq_active > 0 ? fl_g->input_stream_mp3_lowpass_freq->activate() : fl_g->input_stream_mp3_lowpass_freq->deactivate();
    cfg.mp3_codec_stream.lowpass_width_active > 0 ? fl_g->input_stream_mp3_lowpass_width->activate() : fl_g->input_stream_mp3_lowpass_width->deactivate();
    cfg.mp3_codec_stream.highpass_freq_active > 0 ? fl_g->input_stream_mp3_highpass_freq->activate() : fl_g->input_stream_mp3_highpass_freq->deactivate();
    cfg.mp3_codec_stream.highpass_width_active > 0 ? fl_g->input_stream_mp3_highpass_width->activate() : fl_g->input_stream_mp3_highpass_width->deactivate();

    switch (cfg.mp3_codec_stream.resampling_freq) {
    case CHOICE_MP3_RESAMPLING_DISABLED:
        fl_g->choice_stream_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_DISABLED);
        break;
    case 8000:
        fl_g->choice_stream_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_8000);
        break;
    case 11025:
        fl_g->choice_stream_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_11025);
        break;
    case 12000:
        fl_g->choice_stream_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_12000);
        break;
    case 16000:
        fl_g->choice_stream_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_16000);
        break;
    case 22050:
        fl_g->choice_stream_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_22050);
        break;
    case 24000:
        fl_g->choice_stream_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_24000);
        break;
    case 32000:
        fl_g->choice_stream_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_32000);
        break;
    case 44100:
        fl_g->choice_stream_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_44100);
        break;
    case 48000:
        fl_g->choice_stream_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_48000);
        break;
    default:
        fl_g->choice_stream_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_DISABLED);
    }
    ...
    fl_g->check_rec_mp3_force_min_bitrate->value(cfg.mp3_codec_rec.vbr_force_min_bitrate);
    fl_g->check_rec_mp3_activate_lowpass_freq->value(cfg.mp3_codec_rec.lowpass_freq_active);
    fl_g->input_rec_mp3_lowpass_freq->value(cfg.mp3_codec_rec.lowpass_freq);
    fl_g->check_rec_mp3_activate_lowpass_width->value(cfg.mp3_codec_rec.lowpass_width_active);
    fl_g->input_rec_mp3_lowpass_width->value(cfg.mp3_codec_rec.lowpass_width);
    fl_g->check_rec_mp3_activate_highpass_freq->value(cfg.mp3_codec_rec.highpass_freq_active);
    fl_g->input_rec_mp3_highpass_freq->value(cfg.mp3_codec_rec.highpass_freq);
    fl_g->check_rec_mp3_activate_highpass_width->value(cfg.mp3_codec_rec.highpass_width_active);
    fl_g->input_rec_mp3_highpass_width->value(cfg.mp3_codec_rec.highpass_width);

    cfg.mp3_codec_rec.lowpass_freq_active > 0 ? fl_g->input_rec_mp3_lowpass_freq->activate() : fl_g->input_rec_mp3_lowpass_freq->deactivate();
    cfg.mp3_codec_rec.lowpass_width_active > 0 ? fl_g->input_rec_mp3_lowpass_width->activate() : fl_g->input_rec_mp3_lowpass_width->deactivate();
    cfg.mp3_codec_rec.highpass_freq_active > 0 ? fl_g->input_rec_mp3_highpass_freq->activate() : fl_g->input_rec_mp3_highpass_freq->deactivate();
    cfg.mp3_codec_rec.highpass_width_active > 0 ? fl_g->input_rec_mp3_highpass_width->activate() : fl_g->input_rec_mp3_highpass_width->deactivate();

    switch (cfg.mp3_codec_rec.resampling_freq) {
    case CHOICE_MP3_RESAMPLING_DISABLED:
        fl_g->choice_rec_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_DISABLED);
        break;
    case 8000:
        fl_g->choice_rec_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_8000);
        break;
    case 11025:
        fl_g->choice_rec_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_11025);
        break;
    case 12000:
        fl_g->choice_rec_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_12000);
        break;
    case 16000:
        fl_g->choice_rec_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_16000);
        break;
    case 22050:
        fl_g->choice_rec_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_22050);
        break;
    case 24000:
        fl_g->choice_rec_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_24000);
        break;
    case 32000:
        fl_g->choice_rec_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_32000);
        break;
    case 44100:
        fl_g->choice_rec_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_44100);
        break;
    case 48000:
        fl_g->choice_rec_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_48000);
        break;
    default:
        fl_g->choice_rec_mp3_resampling_freq->value(CHOICE_MP3_RESAMPLING_DISABLED);
    }
...
#warning("24 bit wav recording has been disabled because it has not been tested on a big endian machine yet")
    ...
    fl_g->browser_midi_command->add(_("Start broadcasting"));
    fl_g->browser_midi_command->add(_("Stop broadcasting"));
    fl_g->browser_midi_command->add(_("Start recording"));
    fl_g->browser_midi_command->add(_("Stop recording"));
...
void write_log(const char *message, const char *path)
{
    int len;
    FILE *log_fd;
    ...
    */
    ...
    const char *log_file = path != NULL ? path : cfg.main.log_file;
...
void init_main_gui_and_audio(void)
{
    ...
    lame_stream.highpass_width = cfg.mp3_codec_stream.highpass_width * cfg.mp3_codec_stream.highpass_freq_active;
    lame_stream.samplerate_out = cfg.mp3_codec_stream.resampling_freq > 0 ? cfg.mp3_codec_stream.resampling_freq : lame_stream.samplerate_in;
    lame_enc_reinit(&lame_stream);
    ...
    lame_rec.highpass_width = cfg.mp3_codec_rec.highpass_width * cfg.mp3_codec_rec.highpass_freq_active;
    lame_rec.samplerate_out = cfg.mp3_codec_rec.resampling_freq > 0 ? cfg.mp3_codec_rec.resampling_freq : lame_rec.samplerate_in;
    lame_enc_reinit(&lame_rec);
...
void activate_stream_ui_elements(void)
{
    if (!recording) {
        ...
        fl_g->button_cfg_import->activate();
    }
    ...
    fl_g->check_stream_mp3_force_min_bitrate->activate();
    fl_g->choice_stream_mp3_resampling_freq->activate();
    fl_g->check_stream_mp3_activate_lowpass_freq->activate();
    fl_g->check_stream_mp3_activate_lowpass_width->activate();
    fl_g->check_stream_mp3_activate_highpass_freq->activate();
    fl_g->check_stream_mp3_activate_highpass_width->activate();

    if (cfg.mp3_codec_stream.lowpass_freq_active == 1) {
        fl_g->input_stream_mp3_lowpass_freq->activate();
    }
    if (cfg.mp3_codec_stream.lowpass_width_active == 1) {
        fl_g->input_stream_mp3_lowpass_width->activate();
    }
    if (cfg.mp3_codec_stream.highpass_freq_active == 1) {
        fl_g->input_stream_mp3_highpass_freq->activate();
    }
    if (cfg.mp3_codec_stream.highpass_width_active == 1) {
        fl_g->input_stream_mp3_highpass_width->activate();
    }
...
void deactivate_stream_ui_elements(void)
{
    ...
    fl_g->check_stream_mp3_force_min_bitrate->deactivate();
    fl_g->choice_stream_mp3_resampling_freq->deactivate();
    fl_g->check_stream_mp3_activate_lowpass_freq->deactivate();
    fl_g->check_stream_mp3_activate_lowpass_width->deactivate();
    fl_g->check_stream_mp3_activate_highpass_freq->deactivate();
    fl_g->check_stream_mp3_activate_highpass_width->deactivate();
    fl_g->input_stream_mp3_lowpass_freq->deactivate();
    fl_g->input_stream_mp3_lowpass_width->deactivate();
    fl_g->input_stream_mp3_highpass_freq->deactivate();
    fl_g->input_stream_mp3_highpass_width->deactivate();
    ...
    fl_g->button_cfg_import->deactivate();
}
...
void activate_rec_ui_elements(void)
{
    ...
    fl_g->check_rec_mp3_force_min_bitrate->activate();
    fl_g->choice_rec_mp3_resampling_freq->activate();
    fl_g->check_rec_mp3_activate_lowpass_freq->activate();
    fl_g->check_rec_mp3_activate_lowpass_width->activate();
    fl_g->check_rec_mp3_activate_highpass_freq->activate();
    fl_g->check_rec_mp3_activate_highpass_width->activate();

    if (cfg.mp3_codec_rec.lowpass_freq_active == 1) {
        fl_g->input_rec_mp3_lowpass_freq->activate();
    }
    if (cfg.mp3_codec_rec.lowpass_width_active == 1) {
        fl_g->input_rec_mp3_lowpass_width->activate();
    }
    if (cfg.mp3_codec_rec.highpass_freq_active == 1) {
        fl_g->input_rec_mp3_highpass_freq->activate();
    }
    if (cfg.mp3_codec_rec.highpass_width_active == 1) {
        fl_g->input_rec_mp3_highpass_width->activate();
    }
...
void deactivate_rec_ui_elements(void)
{
    ...
    fl_g->check_rec_mp3_force_min_bitrate->deactivate();
    fl_g->choice_rec_mp3_resampling_freq->deactivate();
    fl_g->check_rec_mp3_activate_lowpass_freq->deactivate();
    fl_g->check_rec_mp3_activate_lowpass_width->deactivate();
    fl_g->check_rec_mp3_activate_highpass_freq->deactivate();
    fl_g->check_rec_mp3_activate_highpass_width->deactivate();
    fl_g->input_rec_mp3_lowpass_freq->deactivate();
    fl_g->input_rec_mp3_lowpass_width->deactivate();
    fl_g->input_rec_mp3_highpass_freq->deactivate();
    fl_g->input_rec_mp3_highpass_width->deactivate();
...
int exec_midi_command(int command_id, int msg_type, int value)
{
    /*
    ...
    */
    ...
    case MIDI_CMD_START_STOP_BROADCASTING:
        ...
        else if (msg_type == MIDI_MSG_TYPE_NOTE_ON) {
            if (connected == false) {
                Fl::awake(connect_on_main_thread, NULL);
            }
            else {
        ...
        break;
    case MIDI_CMD_START_BROADCASTING:
        if (connected == false) {
            Fl::awake(connect_on_main_thread, NULL);
        }
        break;
    case MIDI_CMD_STOP_BROADCASTING:
        Fl::awake(disconnect_on_main_thread, &ask);
        break;
    case MIDI_CMD_START_STOP_RECORDING:
        ...
        break;
    case MIDI_CMD_START_RECORDING:
        if (recording == false) {
            Fl::awake(start_record_on_main_thread, &ask);
        }
        break;
    case MIDI_CMD_STOP_RECORDING:
        if (recording == true) {
            Fl::awake(stop_record_on_main_thread, &ask);
        }
        break;
