# Beats 'n Breaks Use This Tool

bnbutt (Beats 'n Breaks Use This Tool) is an easy to use, multi OS streaming tool. It supports ShoutCast and IceCast and runs on Linux, MacOS and Windows. The main purpose of bnbutt is to stream live audio data from your computers Mic or Line input to an Shoutcast or Icecast server. Recording is also possible. It is NOT intended to be a server by itself or automatically stream a set of audio files.

## This Repository

This repository has been created out of the need to have bnbutt read audio input from other channels than the first two of an audio device.
